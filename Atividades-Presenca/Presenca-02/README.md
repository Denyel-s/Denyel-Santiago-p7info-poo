# Presença 02
Implementar um código Pythom que gere uma sequencia de impressa onde sejam mostras as representações decimal, octal, hexadecimal dos valores inteiros de 0 a 225 (que são os valores que um byte pode representar).
...
Código deve ser persistido em um repositório do GitHub.